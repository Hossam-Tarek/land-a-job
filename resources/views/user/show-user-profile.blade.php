        ...
        <div class="col-lg-8 col-sm-12 mt-3   mx-auto ">
            <div class="row bg-light shadow-sm first-card p-3 card-profile-margin">
                    ...
                    <div class="col-lg-10 col-sm-12  pt-2  ">
                        <h3 class="font-weight-bold hover-edit">{{$user->first_name}}  {{$user->last_name}} <a href="#" class="edit-ancor">
                                <i class="fas fa-pencil-alt edit-fontawsom"></i></a></h3>
                        <h6>{{$user->profile->job_title}} at {{$user->company->name}} <a href="#" class="edit-ancor"><i
                                    class="fas fa-pencil-alt edit-fontawsom"></i></a></h6>
                        <p class="text-secondary user-profile-city  hover-edit">{{$user->profile->city->name}}
                            , {{$user->profile->country->name}} <a href="#" class="edit-ancor"><i
                                    class="fas fa-pencil-alt edit-fontawsom"></i></a></p>
                ...
                <div class="row profile-general-info-container">
                    <div class="col-md-6 col-sm-12 px-3 mb-3">
                       <div class="mx-3 pb-3">
                           ...
                           <p class="text-secondary mb-0 ml-3">Education Level : {{$user->profile->education_level}}</p>
                           <p class="text-secondary mb-0 ml-3">Gender : {{$user->profile->gender}}</p>
                           <p class="text-secondary mb-0 ml-3">Military Status : {{$user->profile->military_status}}</p>
                       </div>
                    </div>
