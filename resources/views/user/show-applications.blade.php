...
@section("content")
    ...
    <div class="row pt-3">
        <div class="col-md-7">
            @foreach($jobs as $job)
                <div class="application-container mb-3 position-relative" data-id='{{$job->id}}'>
                    <div class="application pt-4 pb-3 pl-3 pr-3 position-relative" data-id='{{$job->id}}'>
                        ...
                        <div class="p-2 pivot-status mt-4">
                            ...
                            <div class='job-status d-inline-block mr-n3 applied'>
                                <div>
                                    <p class="status-text">Applied</p>
                                    <div class="p-0 m-0">
                            ...
                            <div class='job-status d-inline-block mr-n3 viewed'>
                                <div>
                                    <p class="status-text">@if($job->pivot->status != "Applied"){{"Viewed"}} @else {{"No action yet"}} @endif</p>
                                    <div class="p-0 m-0">
                                        <div class="point d-inline-flex"></div>
                                        <div class="line d-inline-flex mt-n1 ml-n1"></div>
                                    </div>
                            ...
                            <div class='job-status d-inline-block mr-n3 other-status'>
                                <div>
                                    <p class="status-text">@if($job->pivot->status != "Viewed" && $job->pivot->status != "Applied"){{$job->pivot->status}} @else {{"No action yet"}} @endif</p>
                                    <div class="p-0 m-0">
                                        <div class="point d-inline-flex"></div>
                                    </div>
                    ...
                    <div class="position-absolute logo"><img src="{{ asset('avatar/$job->company->logo') }}" alt="" width="70px" height="70px"></div>
                </div>
            @endforeach
        </div>
        ...
        <div class="job d-none" id="job">
            <div class="applications_count-container pt-2 pb-2 pl-4 pr-4 mb-4">
                    <h1 class="font-weight-bolder job_title">fgfghfhg</h1> 
                    <span class="d-inline-block job-city">vnbbn hhbhjv</span>
