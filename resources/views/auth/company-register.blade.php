...
@section('content')
    ...
    <body
        style="background-image: url({{asset('img/8.jpg')}}); background-repeat: no-repeat; background-size: cover; image-resolution: from-image;">
                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row flex justify-content-center">
                                ...
                                <input id="first_name" placeholder="First-Name" type="text"
                                       class="form-control w-75 @error('first_name') is-invalid @enderror"
                            ...
                            <div class="form-group row flex justify-content-center">
                                <input id="last_name" type="text" placeholder="Last-Name"
                                       class="form-control w-75 @error('last_name') is-invalid @enderror"
                            ...
                            <label for="password-confirm"
                                   class=" col-form-label lab">{{ __('Confirm Password') }}</label>
                            <div class="form-group row flex justify-content-center">
                                <input id="password-confirm" placeholder="Confirm-Password" type="password"
                                       class="form-control w-75" name="password_confirmation"
                                       autocomplete="new-password">
                            </div>
