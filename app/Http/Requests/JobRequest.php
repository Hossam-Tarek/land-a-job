...
class JobRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'max_years_of_experience' => 'required|numeric|integer|min:0',
            'vacancies' =>'required|numeric|integer|min:0' ,
            'min_salary' => 'required|numeric|integer|min:0',
            'max_salary' => 'required|numeric|integer|min:0',
